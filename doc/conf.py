...
html_theme_options = {
    ...
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/openalea/branchingnetwork",
...
htmlhelp_basename = "branchingnetwork_documentation"
...
latex_documents = [
    (
        master_doc,
        "branchingnetwork.tex",
        "branchingnetwork Documentation",
        "INRA / INRIA / CIRAD",
        "manual",
    ),
]
...
man_pages = [(master_doc, "openalea.branchingnetwork", "branchingnetwork Documentation", [author], 1)]
